  ...
  <script>
    ...
    function getMasterId() {
        ...
        createdMasterId = url.searchParams.get("id");
        selectedSite = url.searchParams.get("site");

        console.log("id and site from url: ", url.searchParams.get("id"), url.searchParams.get("site"));
        // set 'isEdit' variable to true
        if(edit) {
            isEdit = true;
        }

        $(".audit-id").text("id: " + createdMasterId);
        isForwardAndReverseCheckComplete(createdMasterId);
    }
    ...
    $(function(){
        ...
        $("#forward-check-container, #reverse-check-container, #content-forward-check, #error-container, .system-found-div").hide();
        ...
        $('body').on('click', '.actionButton, .serial-container', function() {
            ...
            if($(this).attr("class").includes("actionButton")) {
                ...
                $( ".serial-container" ).removeClass( "left-menu-active" );
